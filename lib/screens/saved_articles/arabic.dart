...
class _SavedArticlesArabicState extends State<SavedArticlesArabic> {
  ...
  List Articles = [
    ...
    "أ.لك ِّل فرد ح ُّق التماس ملجأ في بلدان أخرى والتمُّتع به خلا ًصا من الاضطهاد.\n ب. لا يمكن التذُّرُع بهذاالحِّق إذا كانت هناك ٌملاحقة ٌناشئة بالفعل عن جريمة غير سياسية أو عن أعمال تناقض مقاص َد الأمم المتحدة ومبادئها.",
    ...
    "أ.لك ِّل شخص ح ُّق المشاركة في إدارة الشؤون العامة لبلده، إ َّما ًمباشرة وإ َّما بواسطة ممِّثلين يختارون في ح ِّرية.\n ب.لك ِّل شخص، بالتساوي مع الآخرين، حق تقلد الوظائف العا َّمة في بلده.\n ت. إراد ُة الشعب هي منا ُط سلطة الحكم ، ويجب أن تتجل َّى هذه الإرادة من خلال انتخابات نزيهة تجرى دورًّيا بالاقتراع العام وعلى قدم المساواة بين الناخبين وبالتصويت السرِّي أو بإجراء مكافئ من حيث ضمان حرِّية التصويت.",
    ...
    "أ.لك ِّل شخص ح ُّق العمل، وفي ح ِّرية اختيار عمله، وفي شروط عمل عادلة وُمرضية، وفي الحماية من البطالة.\n ب. لجميع الأفراد ، دون أ ِّ ي تمييز ، الح ُّق في أ ٍجر متسا ٍو على العمل المتساوي.\n ت.لك ِّل فرد يعمل ح ٌّق في مكافأة عادلة وُمرضية تكفل له ولأسرته عيش ًة لائق ًة بالكرامة البشرية، وُتستك َمل، عند الاقتضاء، بوسائل أخرى للحماية الاجتماعية.\n ث.لك ِّل شخص ح ُّق إنشاء النقابات مع آخرين والانضمام إليها من أجل حماية مصالحه.",
    "لك  ِّل شخص ح ٌّق في الراحة وأوقات الفراغ، وخصو ًصا في تحديد معقول لساعات العمل وفي إجازات دورية مأجورة.",
    "أ.لك ِّل شخص ح ٌّق في مستوى معيشة يكفي لضمان الصحة والرفاهة له ولأسرته،وخاصَّةً على صعيد المأكل والملبس والمسكن والعناية الطبية وصعيد الخدمات الاجتماعية الضرورية، وله الحقُّ في ما يأمن به الغوائل في حالات البطالة أو المرض أو العجز أو الترمُّل أو الشيخوخة أو غير ذلك من الظروف الخارجة عن إرادته والتي تفقده أسباب عيشه.\n ب.للأمومة والطفولة ح ٌّق في رعاية ومساعدة خا َّصتين. ولجميع الأطفال ح ُّق التمُّتع بذات الحماية الاجتماعية سواء ُولدوا في إطار الزواج أو خارج هذا الإطار.",
    "أ.لك ِّل شخص ح ٌّق في التعليم. ويجب أن ُيوَّفر التعلي ُم م َّجاًنا، على الأقل في مرحلتيه الابتدائية والأساسية. ويكون التعليمُ الابتدائيُّ إلزاميًّا. ويكون التعليمُ الفنِّي والمهني متاحًا للعموم. ويكون التعليمُ العالي مُتاحًا للجميع تبعًا لكفاءتهم.\n ب.يجب أن يستهدف التعليمُ التنميةَ الكاملةَ لشخصية الإنسان وتعزيز احترام حقوق الإنسان والحريات الأساسية. كما يجب أن يعزِّز التفاهمَ والتسامحَ والصداقةَ بين جميع الأمم وجميع الفئات العنصرية أو الدينية، وأن يؤيِّد الأنشطةَ التي تضطلع بها الأممُ المتحدةُ لحفظ السلام.\n ت.للآباء، على سبيل الأولوية، ح ُّق اختيار نوع التعليم الذي ُيعطى لأولادهم.",
    "أ.لك ِّل شخص ح ُّق المشاركة الح َّرة في حياة المجتمع الثقافية، وفي الاستمتاع بالفنون ،والإسهام في التقدم العلمي وفي الفوائد التي تنجم عنه.\n ب.لك ِّل شخص ح ٌّق في حماية المصالح المعنوية والمادية المترِّتبة على أ ِّي إنتاج علمي أو أدبي أو فنِّي من صنعه.",
    ...
    "أ.على ك ِّل فرد واجبا ٌت إزاء الجماعة، التي فيها وحدها يمكن أن تنمو شخصيته النمو الحر الكامل.\n ب.لا ُيخضع أ ُّي فرد، في ممارسة حقوقه وح ِّرياته، َّإلا للقيود التي يق ِّررها القانو ُن مستهد ًفا منها، حص ًرا، ضما َن الاعتراف الواجب بحقوق وح ِّريات الآخرين واحترامها، والوفا َء بالعادل من مقتضيات الفضيلة والنظام العام ورفاه الجميع في مجتمع ديمقراطي.\n ت.لا يجوز في أيِّ حال أن تُمارَس هذه الحقوقُ على نحو يناقض مقاصدَ الأمم المتحدة ومبادئها.",
