...
class _SavedArticlesArabicState extends State<SavedArticlesArabic> {
  ...
  List Articles = [
    ...
    "أ. لكِّل فرد حٌّق في حِّرية التن ُّقل وفي اختيار مح ِّل إقامته داخل حدود الدولة.\nب. لكِّل فرد ح ٌّق في مغادرة أ ِّي بلد، بما في ذلك بلده، وفي العودة إلى بلده.",
